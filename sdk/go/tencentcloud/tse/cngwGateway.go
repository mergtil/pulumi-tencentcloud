...
type CngwGateway struct {
	...
	EngineRegion pulumi.StringPtrOutput `pulumi:"engineRegion"`
	// product version. Reference value: `TRIAL`, `STANDARD`(default value), `PROFESSIONAL`.
	FeatureVersion pulumi.StringPtrOutput `pulumi:"featureVersion"`
	// gateway vwersion. Reference value: `2.4.1`, `2.5.1`.
	GatewayVersion pulumi.StringOutput `pulumi:"gatewayVersion"`
	// ingress class name.
	IngressClassName pulumi.StringPtrOutput `pulumi:"ingressClassName"`
...
// engine region of gateway.
func (o CngwGatewayOutput) EngineRegion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CngwGateway) pulumi.StringPtrOutput { return v.EngineRegion }).(pulumi.StringPtrOutput)
}

// product version. Reference value: `TRIAL`, `STANDARD`(default value), `PROFESSIONAL`.
func (o CngwGatewayOutput) FeatureVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CngwGateway) pulumi.StringPtrOutput { return v.FeatureVersion }).(pulumi.StringPtrOutput)
}
...
// ingress class name.
func (o CngwGatewayOutput) IngressClassName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *CngwGateway) pulumi.StringPtrOutput { return v.IngressClassName }).(pulumi.StringPtrOutput)
}
