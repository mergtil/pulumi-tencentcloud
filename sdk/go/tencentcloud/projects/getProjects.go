...
func GetProjects(ctx *pulumi.Context, args *GetProjectsArgs, opts ...pulumi.InvokeOption) (*GetProjectsResult, error) {
	...
	err := ctx.Invoke("tencentcloud:Projects/getProjects:getProjects", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o GetProjectsResultOutput) AllList() pulumi.IntOutput {
	return o.ApplyT(func(v GetProjectsResult) int { return v.AllList }).(pulumi.IntOutput)
}
