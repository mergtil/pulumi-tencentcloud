...
export class CommitCertificateInformation extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CommitCertificateInformationState, opts?: pulumi.CustomResourceOptions): CommitCertificateInformation {
        return new CommitCertificateInformation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:Ssl/commitCertificateInformation:CommitCertificateInformation';

    /**
     * Returns true if the given object is an instance of CommitCertificateInformation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CommitCertificateInformation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CommitCertificateInformation.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: CommitCertificateInformationArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: CommitCertificateInformationArgs | CommitCertificateInformationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CommitCertificateInformationState | undefined;
            ...
            const args = argsOrState as CommitCertificateInformationArgs | undefined;
        ...
        super(CommitCertificateInformation.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface CommitCertificateInformationState {
    /**
     * Certificate Id.
     */
 ...
 */
export interface CommitCertificateInformationArgs {
    /**
     * Certificate Id.
     */
    certificateId: pulumi.Input<string>;
