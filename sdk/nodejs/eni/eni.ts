...
export class Eni extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:Eni/eni:Eni';
     ...
     */
    public /*out*/ readonly ipv4Infos!: pulumi.Output<outputs.Eni.EniIpv4Info[]>;
    /**
     ...
     */
    public readonly ipv4s!: pulumi.Output<outputs.Eni.EniIpv4[] | undefined>;
    /**
     * MAC address.
     */
...
export interface EniState {
     ...
     * An information list of IPv4s. Each element contains the following attributes:
     */
    ipv4Infos?: pulumi.Input<pulumi.Input<inputs.Eni.EniIpv4Info>[]>;
    /**
     * Applying for intranet IPv4s collection, conflict with `ipv4_count`. When there are multiple ipv4s, can only be one
     * primary IP, and the maximum length of the array is 30. Each element contains the following attributes:
     */
    ipv4s?: pulumi.Input<pulumi.Input<inputs.Eni.EniIpv4>[]>;
    /**
     * MAC address.
     */
