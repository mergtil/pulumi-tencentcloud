...
export class PolicyGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:Deprecatedmonitor/policyGroup:PolicyGroup';
     ...
     */
    public /*out*/ readonly bindingObjects!: pulumi.Output<outputs.Deprecatedmonitor.PolicyGroupBindingObject[]>;
    /**
     * A list of threshold rules. Each element contains the following attributes:
     */
    public readonly conditions!: pulumi.Output<outputs.Deprecatedmonitor.PolicyGroupCondition[] | undefined>;
    /**
     ...
     */
    public readonly eventConditions!: pulumi.Output<outputs.Deprecatedmonitor.PolicyGroupEventCondition[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly receivers!: pulumi.Output<outputs.Deprecatedmonitor.PolicyGroupReceiver[]>;
    /**
...
export interface PolicyGroupState {
     ...
     * A list binding objects(list only those in the `provider.region`). Each element contains the following attributes:
     */
    bindingObjects?: pulumi.Input<pulumi.Input<inputs.Deprecatedmonitor.PolicyGroupBindingObject>[]>;
    /**
     * A list of threshold rules. Each element contains the following attributes:
     */
    conditions?: pulumi.Input<pulumi.Input<inputs.Deprecatedmonitor.PolicyGroupCondition>[]>;
    /**
     * A list of dimensions for this policy group.
     */
     ...
     * A list of event rules. Each element contains the following attributes:
     */
    eventConditions?: pulumi.Input<pulumi.Input<inputs.Deprecatedmonitor.PolicyGroupEventCondition>[]>;
    /**
     * Policy group name, length should between 1 and 20.
     */
     ...
     * A list of receivers. Each element contains the following attributes:
     */
    receivers?: pulumi.Input<pulumi.Input<inputs.Deprecatedmonitor.PolicyGroupReceiver>[]>;
    /**
     * Policy group's remark information.
     */
