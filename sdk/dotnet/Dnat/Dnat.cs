...
{
    [TencentcloudResourceType("tencentcloud:Dnat/dnat:Dnat")]
    public partial class Dnat : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Dnat(string name, DnatArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Dnat/dnat:Dnat", name, args ?? new DnatArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dnat(string name, Input<string> id, DnatState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Dnat/dnat:Dnat", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Dnat Get(string name, Input<string> id, DnatState? state = null, CustomResourceOptions? options = null)
        {
            return new Dnat(name, id, state, options);
        }
    }

    public sealed class DnatArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Description of the NAT forward.
        /// </summary>
        ...
        public static new DnatArgs Empty => new DnatArgs();
    }

    public sealed class DnatState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Description of the NAT forward.
        /// </summary>
        ...
        public static new DnatState Empty => new DnatState();
    }
}
