...
{
    [TencentcloudResourceType("tencentcloud:Deprecatedaudit/audit:Audit")]
    public partial class Audit : global::Pulumi.CustomResource
    {
        ...
        public Audit(string name, AuditArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedaudit/audit:Audit", name, args ?? new AuditArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Audit(string name, Input<string> id, AuditState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Deprecatedaudit/audit:Audit", name, state, MakeResourceOptions(options, id))
        {
        }
