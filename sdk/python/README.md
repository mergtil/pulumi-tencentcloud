...
- binary: pulumi-resource-tencentcloud
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-tencentcloud/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-tencentcloud_darwin_amd64_v1
│   └── pulumi-resource-tencentcloud
├── pulumi-tencentcloud_darwin_arm64
│   └── pulumi-resource-tencentcloud
├── pulumi-tencentcloud_linux_amd64_v1
│   └── pulumi-resource-tencentcloud
├── pulumi-tencentcloud_linux_arm64
│   └── pulumi-resource-tencentcloud
├── pulumi-tencentcloud_windows_amd64_v1
│   └── pulumi-resource-tencentcloud.exe
└── pulumi-tencentcloud_windows_arm64
    └── pulumi-resource-tencentcloud.exe
```
