...
class MigrateJobResumeOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] resume_option: resume mode: 1.clearData-Clear target data; 2.overwrite-The task is executed in overwrite mode; 3.normal-No extra
...
class MigrateJobResumeOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MigrateJobResumeOperation resource with the given unique name, props, and options.
