...
class DiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] disk_backup_quota: Specify the disk backup quota. If not uploaded, the default is no backup quota. Currently, only one disk backup quota is
               supported.
