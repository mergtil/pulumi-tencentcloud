...
class RenewInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RenewInstanceInstanceChargePrepaidArgs'] instance_charge_prepaid: Prepaid mode, that is, yearly and monthly subscription related parameter settings. Through this parameter, you can
        ...
        :param pulumi.Input[bool] auto_voucher: Whether to automatically deduct vouchers. Valid values: - true: Automatically deduct vouchers. -false:Do not
               automatically deduct vouchers. Default value: false.
        :param pulumi.Input[bool] renew_data_disk: Whether to renew the data disk. Valid values:true: Indicates that the renewal instance also renews the data disk
...
class RenewInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RenewInstance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[bool] auto_voucher: Whether to automatically deduct vouchers. Valid values: - true: Automatically deduct vouchers. -false:Do not
               automatically deduct vouchers. Default value: false.
        :param pulumi.Input[pulumi.InputType['RenewInstanceInstanceChargePrepaidArgs']] instance_charge_prepaid: Prepaid mode, that is, yearly and monthly subscription related parameter settings. Through this parameter, you can
               specify attributes such as the purchase duration of the Subscription instance and whether to set automatic renewal.
        :param pulumi.Input[str] instance_id: Instance ID.
        :param pulumi.Input[bool] renew_data_disk: Whether to renew the data disk. Valid values:true: Indicates that the renewal instance also renews the data disk
               attached to it.false: Indicates that the instance will be renewed and the data disk attached to it will not be renewed
