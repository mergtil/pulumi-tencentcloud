...
class TrackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] event_names: Track interface name list:- when ResourceType is `*`, EventNames is must `[&amp;quot;*&amp;quot;]`- when ResourceType is
        ...
        :param pulumi.Input[int] track_for_all_members: Whether to enable the delivery of group member operation logs to the group management account or trusted service
...
class Track(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Track resource with the given unique name, props, and options.
