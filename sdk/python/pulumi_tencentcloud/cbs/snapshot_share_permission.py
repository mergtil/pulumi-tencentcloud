...
class SnapshotSharePermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] account_ids: List of account IDs with which a snapshot is shared. For the format of array-type parameters, see[API
        ...
        :param pulumi.Input[str] snapshot_id: The ID of the snapshot to be queried. You can obtain this by using
...
class SnapshotSharePermission(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SnapshotSharePermission resource with the given unique name, props, and options.
