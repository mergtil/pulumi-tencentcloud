...
class ExecuteScalingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] trigger_source: Source that triggers the scaling policy. Valid values: API and CLOUD_MONITOR. Default value: API. The value
...
class ExecuteScalingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ExecuteScalingPolicy resource with the given unique name, props, and options.
