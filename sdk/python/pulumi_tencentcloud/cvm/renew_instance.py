...
class RenewInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] renew_portable_data_disk: Whether to renew the elastic data disk. Valid values: - `TRUE`: Indicates to renew the subscription instance and renew
