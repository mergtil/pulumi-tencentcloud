...
class ChcConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] password: The password can contain 8 to 16 characters, including letters, numbers and special symbols
               (()`~!@#$%^&amp;amp;*-+=_|{}).
        """
...
class ChcConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ChcConfig resource with the given unique name, props, and options.
