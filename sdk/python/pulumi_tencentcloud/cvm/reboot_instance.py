...
class RebootInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] force_reboot: This parameter has been disused. We recommend using StopType instead. Note that ForceReboot and StopType parameters
        ...
        :param pulumi.Input[str] stop_type: Shutdown type. Valid values: `SOFT`: soft shutdown; `HARD`: hard shutdown; `SOFT_FIRST`: perform a soft shutdown first,
...
class RebootInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RebootInstance resource with the given unique name, props, and options.
