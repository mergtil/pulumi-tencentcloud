...
class ExportImagesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role_name: Role name (Default: CVM_QcsRole). Before exporting the images, make sure the role exists, and it has write permission to
               COS.
        """
...
class ExportImages(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ExportImages resource with the given unique name, props, and options.
