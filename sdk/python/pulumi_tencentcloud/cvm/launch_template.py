...
class LaunchTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['LaunchTemplateEnhancedServiceArgs'] enhanced_service: Enhanced service. If this parameter is not specified, cloud monitoring and cloud security services will be enabled by
        ...
        :param pulumi.Input['LaunchTemplateInternetAccessibleArgs'] internet_accessible: The information settings of public network bandwidth. If you do not specify this parameter, the default Internet
               bandwidth is 0 Mbps.
        :param pulumi.Input[str] launch_template_version_description: Instance launch template version description.
        :param pulumi.Input['LaunchTemplateLoginSettingsArgs'] login_settings: The login settings of instance. By default, passwords are randomly generated and notified to users via internal
               messages.
        ...
        :param pulumi.Input['LaunchTemplateSystemDiskArgs'] system_disk: System disk configuration information of the instance. If this parameter is not specified, it is assigned according to
               the system default.
...
class LaunchTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] disaster_recover_group_ids: The ID of disaster recover group.
        :param pulumi.Input[bool] dry_run: Whether to preflight only this request, true or false.
        :param pulumi.Input[pulumi.InputType['LaunchTemplateEnhancedServiceArgs']] enhanced_service: Enhanced service. If this parameter is not specified, cloud monitoring and cloud security services will be enabled by
               default in public images.
        :param pulumi.Input[str] host_name: The host name of CVM.
        :param pulumi.Input[str] hpc_cluster_id: The ID of HPC cluster.
        :param pulumi.Input[str] image_id: Image ID.
        ...
        :param pulumi.Input[str] instance_type: The type of the instance. If this parameter is not specified, the system will dynamically specify the default model
               according to the resource sales in the current region.
        :param pulumi.Input[pulumi.InputType['LaunchTemplateInternetAccessibleArgs']] internet_accessible: The information settings of public network bandwidth. If you do not specify this parameter, the default Internet
               bandwidth is 0 Mbps.
        :param pulumi.Input[str] launch_template_name: The name of launch template.
        :param pulumi.Input[str] launch_template_version_description: Instance launch template version description.
        :param pulumi.Input[pulumi.InputType['LaunchTemplateLoginSettingsArgs']] login_settings: The login settings of instance. By default, passwords are randomly generated and notified to users via internal
               messages.
        :param pulumi.Input[pulumi.InputType['LaunchTemplatePlacementArgs']] placement: The location of instance.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: The security group ID of instance. If this parameter is not specified, the default security group is bound.
        :param pulumi.Input[pulumi.InputType['LaunchTemplateSystemDiskArgs']] system_disk: System disk configuration information of the instance. If this parameter is not specified, it is assigned according to
               the system default.
