...
class LaunchTemplateVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['LaunchTemplateVersionPlacementArgs'] placement: Location of the instance. You can use this parameter to specify the attributes of the instance, such as its availability
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LaunchTemplateVersionDataDiskArgs']]] data_disks: The configuration information of instance data disks. If this parameter is not specified, no data disk will be purchased
               by default.
        :param pulumi.Input[bool] disable_api_termination: Whether the termination protection is enabled. `TRUE`: Enable instance protection, which means that this instance can
        ...
        :param pulumi.Input['LaunchTemplateVersionEnhancedServiceArgs'] enhanced_service: Enhanced service. You can use this parameter to specify whether to enable services such as Anti-DDoS and Cloud Monitor.
        ...
        :param pulumi.Input[str] instance_type: The type of the instance. If this parameter is not specified, the system will dynamically specify the default model
               according to the resource sales in the current region.
        :param pulumi.Input['LaunchTemplateVersionInternetAccessibleArgs'] internet_accessible: Describes the accessibility of an instance in the public network, including its network billing method, maximum
               bandwidth, etc.
        :param pulumi.Input[int] launch_template_version: This parameter, when specified, is used to create instance launch templates. If this parameter is not specified, the
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: Security groups to which the instance belongs. If this parameter is not specified, the instance will be associated with
               default security groups.
        :param pulumi.Input['LaunchTemplateVersionSystemDiskArgs'] system_disk: System disk configuration information of the instance. If this parameter is not specified, it is assigned according to
               the system default.
...
class LaunchTemplateVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LaunchTemplateVersion resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] client_token: A unique string supplied by the client to ensure that the request is idempotent. Its maximum length is 64 ASCII
               characters. If this parameter is not specified, the idem-potency of the request cannot be guaranteed.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['LaunchTemplateVersionDataDiskArgs']]]] data_disks: The configuration information of instance data disks. If this parameter is not specified, no data disk will be purchased
               by default.
        :param pulumi.Input[bool] disable_api_termination: Whether the termination protection is enabled. `TRUE`: Enable instance protection, which means that this instance can
               not be deleted by an API action.`FALSE`: Do not enable the instance protection. Default value: `FALSE`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] disaster_recover_group_ids: Placement group ID. You can only specify one.
        :param pulumi.Input[bool] dry_run: Whether the request is a dry run only.
        :param pulumi.Input[pulumi.InputType['LaunchTemplateVersionEnhancedServiceArgs']] enhanced_service: Enhanced service. You can use this parameter to specify whether to enable services such as Anti-DDoS and Cloud Monitor.
               If this parameter is not specified, Cloud Monitor and Anti-DDoS are enabled for public images by default.
        :param pulumi.Input[str] host_name: Hostname of a CVM.
        :param pulumi.Input[str] hpc_cluster_id: HPC cluster ID. The HPC cluster must and can only be specified for a high-performance computing instance.
        :param pulumi.Input[str] image_id: Image ID.
        ...
        :param pulumi.Input[str] instance_type: The type of the instance. If this parameter is not specified, the system will dynamically specify the default model
               according to the resource sales in the current region.
        :param pulumi.Input[pulumi.InputType['LaunchTemplateVersionInternetAccessibleArgs']] internet_accessible: Describes the accessibility of an instance in the public network, including its network billing method, maximum
               bandwidth, etc.
        :param pulumi.Input[str] launch_template_id: Instance launch template ID. This parameter is used as a basis for creating new template versions.
        :param pulumi.Input[int] launch_template_version: This parameter, when specified, is used to create instance launch templates. If this parameter is not specified, the
               default version will be used.
        ...
        :param pulumi.Input[pulumi.InputType['LaunchTemplateVersionPlacementArgs']] placement: Location of the instance. You can use this parameter to specify the attributes of the instance, such as its availability
               zone, project, and CDH (for dedicated CVMs).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: Security groups to which the instance belongs. If this parameter is not specified, the instance will be associated with
               default security groups.
        :param pulumi.Input[pulumi.InputType['LaunchTemplateVersionSystemDiskArgs']] system_disk: System disk configuration information of the instance. If this parameter is not specified, it is assigned according to
               the system default.
