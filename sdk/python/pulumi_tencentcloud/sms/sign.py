...
class SignArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] document_type: DocumentType is used for enterprise authentication, or website, app authentication, etc. DocumentType: 0, 1, 2, 3, 4, 5,
               6, 7, 8.
        :param pulumi.Input[int] international: Whether it is Global SMS: 0: Mainland China SMS; 1: Global SMS.
        :param pulumi.Input[str] proof_image: You should Base64-encode the image of the identity certificate corresponding to the signature first, remove the prefix
        ...
        :param pulumi.Input[str] commission_image: Power of attorney, which should be submitted if SignPurpose is for use by others. You should Base64-encode the image
