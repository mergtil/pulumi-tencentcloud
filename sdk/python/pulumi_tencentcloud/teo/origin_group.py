...
class OriginGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] origin_type: Type of the origin site. Valid values:- `self`: self-build website.- `cos`: tencent cos.- `third_party`: third party
               cos.
    ...
    def origin_type(self) -> pulumi.Input[str]:
        """
        Type of the origin site. Valid values:- `self`: self-build website.- `cos`: tencent cos.- `third_party`: third party
        cos.
        """
