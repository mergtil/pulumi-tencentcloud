...
class ZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: Specifies how the site is connected to EdgeOne.- `full`: The site is connected via NS.- `partial`: The site is connected
               via CNAME.
...
class _ZoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cname_speed_up: Specifies whether CNAME acceleration is enabled. Valid values: `enabled`, `disabled`.
        :param pulumi.Input[str] cname_status: Ownership verification status of the site when it accesses via CNAME.- `finished`: The site is verified.- `pending`: The
        ...
        :param pulumi.Input[str] status: Site status. Valid values:- `active`: NS is switched.- `pending`: NS is not switched.- `moved`: NS is moved.-
               `deactivated`: this site is blocked.
        :param pulumi.Input[Mapping[str, Any]] tags: Tag description list.
        :param pulumi.Input[str] type: Specifies how the site is connected to EdgeOne.- `full`: The site is connected via NS.- `partial`: The site is connected
               via CNAME.
        :param pulumi.Input['ZoneVanityNameServersArgs'] vanity_name_servers: User-defined name server information. Note: This field may return null, indicating that no valid value can be obtained.
        :param pulumi.Input[Sequence[pulumi.Input['ZoneVanityNameServersIpArgs']]] vanity_name_servers_ips: User-defined name server IP information. Note: This field may return null, indicating that no valid value can be
               obtained.
...
class Zone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[str] type: Specifies how the site is connected to EdgeOne.- `full`: The site is connected via NS.- `partial`: The site is connected
               via CNAME.
        :param pulumi.Input[pulumi.InputType['ZoneVanityNameServersArgs']] vanity_name_servers: User-defined name server information. Note: This field may return null, indicating that no valid value can be obtained.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ZoneVanityNameServersIpArgs']]]] vanity_name_servers_ips: User-defined name server IP information. Note: This field may return null, indicating that no valid value can be
               obtained.
        :param pulumi.Input[str] zone_id: Site ID.
        :param pulumi.Input[str] zone_name: Site name.
        """
