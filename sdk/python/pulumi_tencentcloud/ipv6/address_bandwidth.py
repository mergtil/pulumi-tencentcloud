...
class AddressBandwidthArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bandwidth_package_id: The bandwidth package id, the Legacy account and the ipv6 address to apply for the bandwidth package charge type need to
               be passed in.
        :param pulumi.Input[str] internet_charge_type: Network billing mode. IPV6 currently supports: `TRAFFIC_POSTPAID_BY_HOUR`, for standard account types;
...
class AddressBandwidth(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AddressBandwidth resource with the given unique name, props, and options.
