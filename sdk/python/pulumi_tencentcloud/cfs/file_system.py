...
class FileSystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] capacity: File system capacity, in GiB (required for the Turbo series). For Standard Turbo, the minimum purchase required is
        ...
        :param pulumi.Input[str] cidr_block: CCN IP range used by the CFS (required if the network type is CCN), which cannot conflict with other IP ranges bound in
               CCN.
        :param pulumi.Input[str] mount_ip: IP of mount point.
        :param pulumi.Input[str] name: Name of a file system.
        :param pulumi.Input[str] net_interface: Network type, Default `VPC`. Valid values: `VPC` and `CCN`. Select `VPC` for a Standard or High-Performance file system,
               and `CCN` for a Standard Turbo or High-Performance Turbo one.
        :param pulumi.Input[str] protocol: File system protocol. Valid values: `NFS`, `CIFS`, `TURBO`. If this parameter is left empty, `NFS` is used by default.
               For the Turbo series, you must set this parameter to `TURBO`.
        :param pulumi.Input[str] storage_type: Storage type of the file system. Valid values: `SD` (Standard), `HP` (High-Performance), `TB` (Standard Turbo), and `TP`
