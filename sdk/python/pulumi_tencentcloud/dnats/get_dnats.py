...
__all__ = [
    'GetDnatsResult',
    'AwaitableGetDnatsResult',
    'get_dnats',
    'get_dnats_output',
]

@pulumi.output_type
class GetDnatsResult:
    """
    ...
    def dnat_lists(self) -> Sequence['outputs.GetDnatsDnatListResult']:
...
class AwaitableGetDnatsResult(GetDnatsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDnatsResult(
...
def get_dnats(description: Optional[str] = None,
              ...
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDnatsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Dnats/getDnats:getDnats', __args__, opts=opts, typ=GetDnatsResult).value

    return AwaitableGetDnatsResult(
...
@_utilities.lift_output_func(get_dnats)
def get_dnats_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDnatsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
