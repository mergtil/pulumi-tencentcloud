...
class GetEipsResult:
    ...
    def eip_lists(self) -> Sequence['outputs.GetEipsEipListResult']:
...
def get_eips(eip_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Eips/getEips:getEips', __args__, opts=opts, typ=GetEipsResult).value
...
def get_eips_output(eip_id: Optional[pulumi.Input[Optional[str]]] = None,
