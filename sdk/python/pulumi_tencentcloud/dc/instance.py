...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] access_point_id: Access point of connection.You can call `DescribeAccessPoints` to get the region ID. The selected access point must
               exist and be available.
        :param pulumi.Input[str] direct_connect_name: Connection name.
        :param pulumi.Input[str] line_operator: ISP that provides connections. Valid values: ChinaTelecom (China Telecom), ChinaMobile (China Mobile), ChinaUnicom
               (China Unicom), In-houseWiring (in-house wiring), ChinaOther (other Chinese ISPs), InternationalOperator (international
               ISPs).
        :param pulumi.Input[str] port_type: Port type of connection. Valid values: 100Base-T (100-Megabit electrical Ethernet interface), 1000Base-T (1-Gigabit
