...
class FunctionAliasArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Alias name, which must be unique in the function, can contain 1 to 64 letters, digits, _, and -, and must begin with a
               letter.
...
class FunctionAlias(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FunctionAlias resource with the given unique name, props, and options.
