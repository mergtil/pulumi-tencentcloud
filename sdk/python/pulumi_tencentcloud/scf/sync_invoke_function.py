...
class SyncInvokeFunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] event: Function running parameter, which is in the JSON format. Maximum parameter size is 6 MB. This field corresponds to event
               input parameter.
        :param pulumi.Input[str] log_type: Valid value: None (default) or Tail. If the value is Tail, log in the response will contain the corresponding function
        ...
        :param pulumi.Input[str] routing_key: Traffic routing config in json format, e.g., {k:v}. Please note that both k and v must be strings. Up to 1024 bytes
               allowed.
        """
...
class SyncInvokeFunction(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SyncInvokeFunction resource with the given unique name, props, and options.
