...
class InvokeFunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] client_context: Function running parameter, which is in the JSON format. The maximum parameter size is 6 MB for synchronized invocations
               and 128KB for asynchronized invocations. This field corresponds to event input parameter.
        :param pulumi.Input[str] invocation_type: Fill in RequestResponse for synchronized invocations (default and recommended) and Event for asychronized invocations.
