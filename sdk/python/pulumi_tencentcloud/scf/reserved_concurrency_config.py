...
class ReservedConcurrencyConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] reserved_concurrency_mem: Reserved memory quota of the function. Note: the upper limit for the total reserved quota of the function is the user's
...
class ReservedConcurrencyConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ReservedConcurrencyConfig resource with the given unique name, props, and options.
