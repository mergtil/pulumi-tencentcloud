...
class TerminateAsyncEventArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] grace_shutdown: Whether to enable grace shutdown. If it's true, a SIGTERM signal is sent to the specified request. See [Sending
               termination
...
class TerminateAsyncEvent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TerminateAsyncEvent resource with the given unique name, props, and options.
