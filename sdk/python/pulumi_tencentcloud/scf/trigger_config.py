...
class TriggerConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] qualifier: Function version. It defaults to `$LATEST`. It's recommended to use
...
class TriggerConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TriggerConfig resource with the given unique name, props, and options.
