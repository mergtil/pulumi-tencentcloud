...
class ProvisionedConcurrencyConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] version_provisioned_concurrency_num: Provisioned concurrency amount. Note: there is an upper limit for the sum of provisioned concurrency amounts of all
        ...
        :param pulumi.Input[str] provisioned_type: Specifies the provisioned concurrency type. Default: Static provisioned concurrency. ConcurrencyUtilizationTracking:
