...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] instance_charge_type_prepaid_renew_flag: Auto renewal flag. 1: manual renewal, 2: automatic renewal, 3: no renewal and no notification. Must set when
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceReplicationArgs']]] replications: Specify List of instance Replications, premium only. The available [source region
...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[bool] open_public_operation: Control public network access.
        :param pulumi.Input[int] registry_charge_type: Charge type of instance. 1: postpaid; 2: prepaid. Default is postpaid.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceReplicationArgs']]]] replications: Specify List of instance Replications, premium only. The available [source region
               list](https://www.tencentcloud.com/document/api/1051/41101) is here.
