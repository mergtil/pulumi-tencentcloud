...
class CommandArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] working_directory: Command execution path. The default value is /root for `SHELL` commands and C:/Program Files/qcloudtat_agent/workdir for
               `POWERSHELL` commands.
        """
...
class _CommandState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Command description. The maximum length is 120 characters.
        :param pulumi.Input[bool] enable_parameter: Whether to enable the custom parameter feature.This cannot be modified once created.Default value: `false`.
        :param pulumi.Input[str] formatted_description: Formatted description of the command. This parameter is an empty string for user commands and contains values for public
               commands.
        :param pulumi.Input[str] output_cos_bucket_url: The COS bucket URL for uploading logs. The URL must start with `https`, such as
               `https://BucketName-123454321.cos.ap-beijing.myqcloud.com`.
        :param pulumi.Input[str] output_cos_key_prefix: The COS bucket directory where the logs are saved. Check below for the rules of the directory name.1. It must be a
