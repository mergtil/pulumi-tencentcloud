...
class InvocationCommandAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] default_parameters: The default value of the custom parameter value when it is enabled. The field type is JSON encoded string. For example,
        ...
        :param pulumi.Input[str] output_cos_bucket_url: The COS bucket URL for uploading logs; The URL must start with https, such as
               https://BucketName-123454321.cos.ap-beijing.myqcloud.com.
        :param pulumi.Input[str] output_cos_key_prefix: The COS bucket directory where the logs are saved; Check below for the rules of the directory name: 1 It must be a
               ...
               slashes.
        :param pulumi.Input[str] parameters: Custom parameters of Command. The field type is JSON encoded string. For example, {varA: 222}.key is the name of the
        ...
        :param pulumi.Input[str] username: The username used to execute the command on the CVM or Lighthouse instance.The principle of least privilege is the best
        ...
        :param pulumi.Input[str] working_directory: Command execution path. The default value is /root for SHELL commands and C:Program Filesqcloudtat_agentworkdir for
               POWERSHELL commands.
        """
...
class InvocationCommandAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InvocationCommandAttachment resource with the given unique name, props, and options.
