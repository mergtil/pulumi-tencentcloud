...
class TmpTkeBasicConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Name. The naming rule is: namespace/name. If you don&#39;t have any namespace, use the default namespace: kube-system,
...
class TmpTkeBasicConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TmpTkeBasicConfig resource with the given unique name, props, and options.
