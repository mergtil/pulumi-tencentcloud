...
class BindingReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BindingReceiverReceiversArgs'] receivers: A list of receivers(will overwrite the configuration of the server or other resources). Each element contains the
...
class BindingReceiver(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BindingReceiver resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[int] group_id: Policy group ID for binding receivers.
        :param pulumi.Input[pulumi.InputType['BindingReceiverReceiversArgs']] receivers: A list of receivers(will overwrite the configuration of the server or other resources). Each element contains the
               following attributes:
        """
        ...
    @overload
