...
class Ccn(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Ccn resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a Ccn resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CcnArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CcnArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CcnArgs.__new__(CcnArgs)
        ...
        super(Ccn, __self__).__init__(
            'tencentcloud:Ccn/ccn:Ccn',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            qos: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, Any]]] = None) -> 'Ccn':
        """
        ...
        __props__ = _CcnState.__new__(_CcnState)
        ...
        __props__.__dict__["tags"] = tags
        return Ccn(resource_name, opts=opts, __props__=__props__)
