...
class PersonSampleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] usages: Material application scene, optional value:1. Recognition.Face: used for content recognition 2. Review.Face: used for
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] face_contents: Material image [Base64](https://tools.ietf.org/html/rfc4648) encoded string only supports jpeg and png image formats.
...
class PersonSample(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PersonSample resource with the given unique name, props, and options.
