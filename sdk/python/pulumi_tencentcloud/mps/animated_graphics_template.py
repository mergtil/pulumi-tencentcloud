...
class AnimatedGraphicsTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] height: The maximum value of the animation height (or short side), value range: 0 and [128, 4096], unit: px.When Width and
        ...
        :param pulumi.Input[int] width: The maximum value of the animation width (or long side), value range: 0 and [128, 4096], unit: px.When Width and Height
...
class AnimatedGraphicsTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AnimatedGraphicsTemplate resource with the given unique name, props, and options.
