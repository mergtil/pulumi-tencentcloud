...
class WorkflowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['WorkflowTriggerArgs'] trigger: The trigger rule bound to the workflow, when the uploaded video hits the rule to this object, the workflow will be
               triggered.
        ...
        :param pulumi.Input[str] output_dir: The target directory of the output file generated by media processing, if not filled, it means that it is consistent
        ...
        :param pulumi.Input['WorkflowTaskNotifyConfigArgs'] task_notify_config: The event notification configuration of the task, if it is not filled, it means that the event notification will not be
               obtained.
        :param pulumi.Input[int] task_priority: The priority of the workflow, the larger the value, the higher the priority, the value range is -10 to 10, and blank
               means 0.
        """
...
class Workflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[pulumi.InputType['WorkflowTaskNotifyConfigArgs']] task_notify_config: The event notification configuration of the task, if it is not filled, it means that the event notification will not be
               obtained.
        :param pulumi.Input[int] task_priority: The priority of the workflow, the larger the value, the higher the priority, the value range is -10 to 10, and blank
               means 0.
        :param pulumi.Input[pulumi.InputType['WorkflowTriggerArgs']] trigger: The trigger rule bound to the workflow, when the uploaded video hits the rule to this object, the workflow will be
               triggered.
        :param pulumi.Input[str] workflow_name: Workflow name, up to 128 characters. The name is unique for the same user.
        """
        ...
