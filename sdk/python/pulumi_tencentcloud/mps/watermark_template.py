...
class WatermarkTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] coordinate_origin: Origin position, optional value:TopLeft: Indicates that the origin of the coordinates is at the upper left corner of the
        ...
        :param pulumi.Input[str] x_pos: The horizontal position of the origin of the watermark from the origin of the coordinates of the video image. Support %,
        ...
        :param pulumi.Input[str] y_pos: The vertical position of the origin of the watermark from the origin of the coordinates of the video image. Support %,
