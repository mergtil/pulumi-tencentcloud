...
class BackupPlanConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] backup_periods: Backup cycle, which means on which days each week the instance will be backed up. The parameter value should be the
...
class BackupPlanConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BackupPlanConfig resource with the given unique name, props, and options.
