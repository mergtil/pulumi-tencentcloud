...
class IsolateDbInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] db_instance_id_sets: List of resource IDs. Note that currently you cannot isolate multiple instances at the same time. Only one instance ID
...
class IsolateDbInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IsolateDbInstanceOperation resource with the given unique name, props, and options.
