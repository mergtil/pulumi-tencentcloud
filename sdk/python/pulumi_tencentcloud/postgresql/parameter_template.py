...
class ParameterTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ParameterTemplateModifyParamEntrySetArgs']]] modify_param_entry_sets: The set of parameters that need to be modified or added. Note: the same parameter cannot appear in the set of modifying
...
class ParameterTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ParameterTemplate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] db_engine: Database engine, such as postgresql, mssql_compatible.
        :param pulumi.Input[str] db_major_version: The major database version number, such as 11, 12, 13.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] delete_param_sets: The set of parameters that need to be deleted.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ParameterTemplateModifyParamEntrySetArgs']]]] modify_param_entry_sets: The set of parameters that need to be modified or added. Note: the same parameter cannot appear in the set of modifying
               and adding and deleting at the same time.
        :param pulumi.Input[str] template_description: Parameter template description, which can contain 1-60 letters, digits, and symbols (-_./()+=:@).
        :param pulumi.Input[str] template_name: Template name, which can contain 1-60 letters, digits, and symbols (-_./()+=:@).
        """
