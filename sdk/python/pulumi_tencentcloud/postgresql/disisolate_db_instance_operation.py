...
class DisisolateDbInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] db_instance_id_sets: List of resource IDs. Note that currently you cannot remove multiple instances from isolation at the same time. Only one
...
class DisisolateDbInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DisisolateDbInstanceOperation resource with the given unique name, props, and options.
