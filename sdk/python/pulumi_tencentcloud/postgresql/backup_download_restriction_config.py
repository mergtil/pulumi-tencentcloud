...
class BackupDownloadRestrictionConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] restriction_type: Backup file download restriction type: NONE:Unlimited, both internal and external networks can be downloaded.
...
class BackupDownloadRestrictionConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BackupDownloadRestrictionConfig resource with the given unique name, props, and options.
