...
class SecurityGroupConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] db_instance_id: Instance ID. Either this parameter or ReadOnlyGroupId must be passed in. If both parameters are passed in,
               ReadOnlyGroupId will be ignored.
        :param pulumi.Input[str] read_only_group_id: RO group ID. Either this parameter or DBInstanceId must be passed in. To query the security groups associated with the
...
class SecurityGroupConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SecurityGroupConfig resource with the given unique name, props, and options.
