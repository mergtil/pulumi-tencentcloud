...
class DbInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] shard_count: The number of instance fragments, the optional range is 2-8, and new fragments can be added to a maximum of 64 fragments
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] zones: The availability zone distribution of shard nodes can be filled with up to two availability zones. When the shard
        ...
        :param pulumi.Input[int] auto_renew_flag: Automatic renewal flag, 0 means the default state (the user has not set it, that is, the initial state is manual
        ...
        :param pulumi.Input[str] db_version_id: Database engine version, currently available: 8.0.18, 10.1.9, 5.7.17. 8.0.18 - MySQL 8.0.18; 10.1.9 - Mariadb 10.1.9;
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DbInstanceInitParamArgs']]] init_params: parameter list. The optional values of this interface are: character_set_server (character set, must be passed),
        ...
        :param pulumi.Input[int] project_id: Project ID, which can be obtained by viewing the project list, if not passed, it will be associated with the default
               project.
        :param pulumi.Input[Sequence[pulumi.Input['DbInstanceResourceTagArgs']]] resource_tags: Array of tag key-value pairs.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: Security group ids, the security group can be passed in the form of an array, compatible with the previous
...
class DbInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] dcn_region: DCN source region.
        :param pulumi.Input[bool] extranet_access: Whether to open the extranet access.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DbInstanceInitParamArgs']]]] init_params: parameter list. The optional values of this interface are: character_set_server (character set, must be passed),
               lower_case_table_names (table name is case sensitive, must be passed, 0 - sensitive; 1 - insensitive), innodb_page_size
               (innodb data page, default 16K), sync_mode ( Synchronous mode: 0 - asynchronous; 1 - strong synchronous; 2 - strong
               synchronous degenerate. The default is strong synchronous degenerate) .
        :param pulumi.Input[str] instance_name: Instance name, you can set the name of the instance independently through this field.
