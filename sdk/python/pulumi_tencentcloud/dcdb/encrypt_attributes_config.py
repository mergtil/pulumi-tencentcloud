...
class EncryptAttributesConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] encrypt_enabled: whether to enable data encryption. Notice: it is not supported to turn it off after it is turned on. The optional
...
class EncryptAttributesConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EncryptAttributesConfig resource with the given unique name, props, and options.
