...
class TimeWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_id: Instance ID in the format of cdb-c1nl9rpv or cdbro-c1nl9rpv. It is the same as the instance ID displayed on the
               TencentDB Console page.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] time_ranges: Time period available for maintenance after modification in the format of 10:00-12:00. Each period lasts from half an
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] weekdays: Specifies for which day to modify the time period. Value range: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday,
...
class TimeWindow(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TimeWindow resource with the given unique name, props, and options.
