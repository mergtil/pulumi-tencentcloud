...
class RoInstanceIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_id: Read-only instance ID, in the format: cdbro-3i70uj0k, which is the same as the read-only instance ID displayed on the
...
class RoInstanceIp(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RoInstanceIp resource with the given unique name, props, and options.
