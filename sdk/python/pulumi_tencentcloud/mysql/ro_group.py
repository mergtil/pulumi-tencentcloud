...
class RoGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] is_balance_ro_load: Whether to rebalance the load of RO instances in the RO group. Supported values include: 1 - rebalance load; 0 - do not
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RoGroupRoWeightValueArgs']]] ro_weight_values: The weight of the instance within the RO group. If the weight mode of the RO group is changed to user-defined mode
...
class RoGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RoGroup resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RoGroupRoWeightValueArgs']]]] ro_weight_values: The weight of the instance within the RO group. If the weight mode of the RO group is changed to user-defined mode
               (custom), this parameter must be set, and the weight value of each RO instance needs to be set.
        """
        ...
    @overload
