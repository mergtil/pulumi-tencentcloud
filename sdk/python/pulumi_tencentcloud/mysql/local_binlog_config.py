...
class LocalBinlogConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] save_hours: Retention period of local binlog. Valid range: 72-168 hours. When there is disaster recovery instance, the valid range
...
class LocalBinlogConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LocalBinlogConfig resource with the given unique name, props, and options.
