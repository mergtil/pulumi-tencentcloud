...
class RollbackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] strategy: Rollback strategy. Available values are: table, db, full; the default value is full. table- Extremely fast rollback
...
class Rollback(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Rollback resource with the given unique name, props, and options.
