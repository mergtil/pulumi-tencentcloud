...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] max_user_connections: The maximum number of available connections for a new account, the default value is 10240, and the maximum value that
               can be set is 10240.
