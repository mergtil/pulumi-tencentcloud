...
class RenewDbInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_id: The instance ID to be renewed, the format is: cdb-c1nl9rpv, which is the same as the instance ID displayed on the cloud
        ...
        :param pulumi.Input[str] modify_pay_type: If you need to renew the Pay-As-You-Go instance to a Subscription instance, the value of this input parameter needs to
...
class RenewDbInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RenewDbInstanceOperation resource with the given unique name, props, and options.
