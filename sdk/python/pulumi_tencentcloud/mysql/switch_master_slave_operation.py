...
class SwitchMasterSlaveOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dst_slave: target instance. Possible values: `first` - first standby; `second` - second standby. The default value is `first`, and
               only multi-AZ instances support setting it to `second`.
        :param pulumi.Input[bool] force_switch: Whether to force switch. Default is False. Note that if you set the mandatory switch to True, there is a risk of data
               loss on the instance, so use it with caution.
        :param pulumi.Input[bool] wait_switch: Whether to switch within the time window. The default is False, i.e. do not switch within the time window. Note that if
...
class SwitchMasterSlaveOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SwitchMasterSlaveOperation resource with the given unique name, props, and options.
