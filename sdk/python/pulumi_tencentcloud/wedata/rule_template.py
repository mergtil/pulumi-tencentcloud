...
class RuleTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] quality_dim: Quality inspection dimensions. `1`: Accuracy, `2`: Uniqueness, `3`: Completeness, `4`: Consistency, `5`: Timeliness,
               `6`: Effectiveness.
...
class RuleTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RuleTemplate resource with the given unique name, props, and options.
