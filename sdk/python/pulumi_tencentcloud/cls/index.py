...
class IndexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] include_internal_fields: Internal field marker of full-text index. Default value: false. Valid value: false: excluding internal fields; true:
               including internal fields.
        :param pulumi.Input[int] metadata_flag: Metadata flag. Default value: 0. Valid value: 0: full-text index (including the metadata field with key-value index
