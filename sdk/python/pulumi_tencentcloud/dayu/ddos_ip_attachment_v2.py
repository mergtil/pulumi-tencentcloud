...
class DdosIpAttachmentV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DdosIpAttachmentV2BoundIpListArgs']]] bound_ip_lists: Array of IPs to bind to the Anti-DDoS instance. For Anti-DDoS Pro Single IP instance, the array contains only one IP. If
...
class DdosIpAttachmentV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DdosIpAttachmentV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] bgp_instance_id: Anti-DDoS instance ID.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DdosIpAttachmentV2BoundIpListArgs']]]] bound_ip_lists: Array of IPs to bind to the Anti-DDoS instance. For Anti-DDoS Pro Single IP instance, the array contains only one IP. If
               there are no IPs to bind, it is empty; however, either BoundDevList or UnBoundDevList must not be empty.
        """
        ...
    @overload
