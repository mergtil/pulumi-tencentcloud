...
class MediaVideoMontageTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] duration: Collection duration 1: Default automatic analysis duration, 2: The unit is seconds, 3: Support float format, execution
...
class MediaVideoMontageTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MediaVideoMontageTemplate resource with the given unique name, props, and options.
