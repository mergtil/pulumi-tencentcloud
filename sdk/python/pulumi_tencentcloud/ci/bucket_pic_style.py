...
class BucketPicStyleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] style_name: style name, style names are case-sensitive, and a combination of uppercase and lowercase letters, numbers, and `$ + _ (
               )` is supported.
        """
...
class BucketPicStyle(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BucketPicStyle resource with the given unique name, props, and options.
