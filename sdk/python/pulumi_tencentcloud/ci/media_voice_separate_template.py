...
class MediaVoiceSeparateTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] audio_mode: Output audio IsAudio: output human voice, IsBackground: output background sound, AudioAndBackground: output vocal and
               background sound.
...
class MediaVoiceSeparateTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MediaVoiceSeparateTemplate resource with the given unique name, props, and options.
