...
class MediaTtsTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] mode: Processing mode, default value Asyc, Asyc (asynchronous composition), Sync (synchronous composition), When Asyc is
...
class MediaTtsTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MediaTtsTemplate resource with the given unique name, props, and options.
