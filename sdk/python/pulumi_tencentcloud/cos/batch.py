...
class BatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role_arn: COS resource identifier, which is used to identify the role you created. You need this resource identifier to verify
               your identity.
        ...
        :param pulumi.Input[str] description: Mission description. If you configured this information when you created the task, the content is returned. The
               description length ranges from 0 to 256 bytes.
        :param pulumi.Input[str] status: Current status of the task. Legal parameter values include Active, Cancelled, Cancelling, Complete, Completing, Failed,
...
class Batch(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Batch resource with the given unique name, props, and options.
