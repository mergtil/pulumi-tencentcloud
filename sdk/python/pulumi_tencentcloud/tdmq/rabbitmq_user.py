...
class RabbitmqUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] tags: User tag, used to determine the permission range for changing user access to RabbitMQ Management. Management: regular
...
class RabbitmqUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RabbitmqUser resource with the given unique name, props, and options.
