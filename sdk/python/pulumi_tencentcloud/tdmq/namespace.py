...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['NamespaceRetentionPolicyArgs'] retention_policy: The Policy of message to retain. Format like: `{time_in_minutes: Int, size_in_mb: Int}`. `time_in_minutes`: the time of
...
class Namespace(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[int] msg_ttl: The expiration time of unconsumed message.
        :param pulumi.Input[str] remark: Description of the namespace.
        :param pulumi.Input[pulumi.InputType['NamespaceRetentionPolicyArgs']] retention_policy: The Policy of message to retain. Format like: `{time_in_minutes: Int, size_in_mb: Int}`. `time_in_minutes`: the time of
               message to retain; `size_in_mb`: the size of message to retain.
        """
        ...
    @overload
