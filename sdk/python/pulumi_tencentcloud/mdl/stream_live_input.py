...
class StreamLiveInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['StreamLiveInputInputSettingArgs']]] input_settings: Input settings. For the type `RTMP_PUSH`, `RTMP_PULL`, `HLS_PULL`, or `MP4_PULL`, 1 or 2 inputs of the corresponding
               type can be configured.
        :param pulumi.Input[str] name: Input name, which can contain 1-32 case-sensitive letters, digits, and underscores and must be unique at the region
               level.
...
class StreamLiveInput(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['StreamLiveInputInputSettingArgs']]]] input_settings: Input settings. For the type `RTMP_PUSH`, `RTMP_PULL`, `HLS_PULL`, or `MP4_PULL`, 1 or 2 inputs of the corresponding
               type can be configured.
        :param pulumi.Input[str] name: Input name, which can contain 1-32 case-sensitive letters, digits, and underscores and must be unique at the region
               level.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: ID of the input security group to attachYou can attach only one security group to an input.
