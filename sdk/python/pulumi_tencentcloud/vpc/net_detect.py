...
class NetDetectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] next_hop_destination: The destination gateway of the next hop, the value is related to the next hop type. If the next hop type is VPN, and the
        ...
        :param pulumi.Input[str] next_hop_type: The next hop type, currently we support the following types: `VPN`: VPN gateway; `DIRECTCONNECT`: private line gateway;
...
class NetDetect(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a NetDetect resource with the given unique name, props, and options.
