...
class VpcArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] cidr_block: A network address block which should be a subnet of the three internal network segments (10.0.0.0/16, 172.16.0.0/12 and
               192.168.0.0/16).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] assistant_cidrs: List of Assistant CIDR, NOTE: Only `NORMAL` typed CIDRs included, check the Docker CIDR by readonly
...
class Vpc(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_multicast: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, Any]]] = None) -> 'Vpc':
        """
