...
class SnapshotPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] create_new_cos: Whether to create a new cos bucket, the default is False.Note: This field may return null, indicating that no valid
