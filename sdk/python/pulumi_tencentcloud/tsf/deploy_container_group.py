...
class DeployContainerGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] agent_mem_limit: The maximum amount of memory in MiB allocated to the agent container corresponds to the &amp;#39;limit&amp;#39; field in
               Kubernetes.
        ...
        :param pulumi.Input[str] cpu_limit: The maximum number of CPU cores for the business container, corresponding to the limit in K8S. If not specified, it
               defaults to twice the request.
        :param pulumi.Input[str] cpu_request: The number of CPU cores allocated to the business container, corresponding to the request in K8S. The default value is
               0.25.
        :param pulumi.Input[bool] deploy_agent: Whether to deploy the agent container. If this parameter is not specified, the agent container will not be deployed by
               default.
        :param pulumi.Input[bool] do_not_start: Not start right away.
        :param pulumi.Input[Sequence[pulumi.Input['DeployContainerGroupEnvArgs']]] envs: The environment variables that the application runs in the deployment group. If this parameter is not specified, no
               additional environment variables are set by default.
        :param pulumi.Input['DeployContainerGroupHealthCheckSettingsArgs'] health_check_settings: The configuration information for health checks. If this parameter is not specified, the health check is not set by
               default.
        ...
        :param pulumi.Input[str] istio_cpu_limit: The maximum amount of CPU cores allocated to the istio proxy container corresponds to the &amp;#39;limit&amp;#39; field
               in Kubernetes.
        :param pulumi.Input[str] istio_cpu_request: The number of CPU cores allocated to the istio proxy container corresponds to the &amp;#39;request&amp;#39; field in
               Kubernetes.
        ...
        :param pulumi.Input[str] mem_limit: The maximum memory size in MiB for the business container, corresponding to the limit in K8S. If not specified, it
               defaults to twice the request.
        :param pulumi.Input[str] mem_request: The amount of memory in MiB allocated to the business container, corresponding to the request in K8S. The default value
               is 640 MiB.
...
class DeployContainerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DeployContainerGroup resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[bool] deploy_agent: Whether to deploy the agent container. If this parameter is not specified, the agent container will not be deployed by
               default.
        :param pulumi.Input[bool] do_not_start: Not start right away.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DeployContainerGroupEnvArgs']]]] envs: The environment variables that the application runs in the deployment group. If this parameter is not specified, no
               additional environment variables are set by default.
        :param pulumi.Input[str] group_id: group Id.
        :param pulumi.Input[pulumi.InputType['DeployContainerGroupHealthCheckSettingsArgs']] health_check_settings: The configuration information for health checks. If this parameter is not specified, the health check is not set by
               default.
        :param pulumi.Input[bool] incremental_deployment: Whether to perform incremental deployment. The default value is false, which means full update.
        :param pulumi.Input[int] instance_num: instance number.
        :param pulumi.Input[str] istio_cpu_limit: The maximum amount of CPU cores allocated to the istio proxy container corresponds to the &amp;#39;limit&amp;#39; field
