...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] max_cluster_service_num: The maximum number of services in the cluster. The value ranges from 32 to 32768. If it is not a power of 2, the nearest
               power of 2 will be taken up.
        :param pulumi.Input[int] max_node_pod_num: The maximum number of Pods on each Node in the cluster. The value ranges from 4 to 256. When the value is not a power of
