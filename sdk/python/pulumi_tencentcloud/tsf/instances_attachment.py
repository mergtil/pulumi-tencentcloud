...
class InstancesAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_import_mode: Cloud server import mode, required for virtual machine clusters, not required for container clusters. R: Reinstall TSF
...
class InstancesAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InstancesAttachment resource with the given unique name, props, and options.
