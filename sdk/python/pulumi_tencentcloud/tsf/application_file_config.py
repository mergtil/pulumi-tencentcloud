...
class ApplicationFileConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] config_file_value: Configuration file content (the original content encoding needs to be in utf-8 format, if the ConfigFileCode is gbk, it
        ...
        :param pulumi.Input[str] config_file_code: Configuration file encoding, utf-8 or gbk. Note: If you choose gbk, you need the support of a new version of
...
class ApplicationFileConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ApplicationFileConfig resource with the given unique name, props, and options.
