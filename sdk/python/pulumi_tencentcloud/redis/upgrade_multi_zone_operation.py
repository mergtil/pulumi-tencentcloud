...
class UpgradeMultiZoneOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] upgrade_proxy_and_redis_server: After you upgrade Multi-AZ, whether the nearby access feature is supported.true: Supports nearby access.The upgrade
...
class UpgradeMultiZoneOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a UpgradeMultiZoneOperation resource with the given unique name, props, and options.
