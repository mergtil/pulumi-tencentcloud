...
class ClearInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] password: Redis instance password (password-free instances do not need to pass passwords, non-password-free instances must be
               transmitted).
        """
...
class ClearInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ClearInstanceOperation resource with the given unique name, props, and options.
