...
class ParamTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ParamTemplateParamsOverrideArgs']]] params_overrides: Specify override parameter list, NOTE: Do not remove override params once set, removing will not take effects to current
               value.
        :param pulumi.Input[int] product_type: Specify product type. Valid values: 1 (Redis 2.8 Memory Edition in cluster architecture), 2 (Redis 2.8 Memory Edition in
...
class ParamTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] description: Parameter template description.
        :param pulumi.Input[str] name: Parameter template name.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ParamTemplateParamsOverrideArgs']]]] params_overrides: Specify override parameter list, NOTE: Do not remove override params once set, removing will not take effects to current
               value.
        :param pulumi.Input[int] product_type: Specify product type. Valid values: 1 (Redis 2.8 Memory Edition in cluster architecture), 2 (Redis 2.8 Memory Edition in
               standard architecture), 3 (CKV 3.2 Memory Edition in standard architecture), 4 (CKV 3.2 Memory Edition in cluster
               architecture), 5 (Redis 2.8 Memory Edition in standalone architecture), 6 (Redis 4.0 Memory Edition in standard
