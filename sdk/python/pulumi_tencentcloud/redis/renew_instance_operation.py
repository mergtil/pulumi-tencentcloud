...
class RenewInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] modify_pay_mode: Identifies whether the billing model is modified:The current instance billing mode is pay-as-you-go, which is prepaid
...
class RenewInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RenewInstanceOperation resource with the given unique name, props, and options.
