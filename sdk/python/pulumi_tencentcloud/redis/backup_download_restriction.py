...
class BackupDownloadRestrictionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] limit_type: Types of network restrictions for downloading backup files:- NoLimit: There is no limit, and backup files can be
        ...
        :param pulumi.Input[str] ip_comparison_symbol: Identifies whether the customized LimitIP address can download the backup file.- In: Custom IP addresses are available
               for download.- NotIn: Custom IPs are not available for download.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] limit_ips: A custom VPC IP address for downloadable backup files.If the parameter LimitType is **Customize**, you need to configure
               this parameter.
        :param pulumi.Input[Sequence[pulumi.Input['BackupDownloadRestrictionLimitVpcArgs']]] limit_vpcs: A custom VPC ID for a downloadable backup file.If the parameter LimitType is **Customize**, you need to configure this
               parameter.
...
class BackupDownloadRestriction(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BackupDownloadRestriction resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] limit_type: Types of network restrictions for downloading backup files:- NoLimit: There is no limit, and backup files can be
               ...
               automatically assigned by Tencent Cloud can download backup files.- Customize: refers to a user-defined private network
               downloadable backup file.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['BackupDownloadRestrictionLimitVpcArgs']]]] limit_vpcs: A custom VPC ID for a downloadable backup file.If the parameter LimitType is **Customize**, you need to configure this
               parameter.
        :param pulumi.Input[str] vpc_comparison_symbol: This parameter only supports entering In, which means that the custom LimitVpc can download the backup file.
        """
        ...
