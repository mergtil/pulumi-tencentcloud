...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_password: 1: Length 8-30 digits, it is recommended to use a password of more than 12 digits; 2: Cannot start with `/`; 3: Include
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] readonly_policies: Routing policy: Enter master or replication, which indicates the master node or slave node, cannot be empty when
