...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] engine_product_version: Engine product version. Reference value: `Nacos`: `TRIAL`: Development version, optional node num: `1`, optional spec
        ...
        :param pulumi.Input[str] engine_region: engine deploy region. Reference value: `China area` Reference value: `ap-guangzhou`, `ap-beijing`, `ap-chengdu`,
        ...
        :param pulumi.Input[str] engine_version: An open source version of the engine. Each engine supports different open source versions, refer to the product
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceEngineRegionInfoArgs']]] engine_region_infos: Details about the regional configuration of the engine in cross-region deployment, only zookeeper professional requires
...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] engine_region: engine deploy region. Reference value: `China area` Reference value: `ap-guangzhou`, `ap-beijing`, `ap-chengdu`,
               ...
               Reference value: `ap-hongkong`, `ap-taipei`, `ap-jakarta`, `ap-singapore`, `ap-bangkok`, `ap-seoul`, `ap-tokyo`. `North
               America area` Reference value: `na-toronto`, `sa-saopaulo`, `na-siliconvalley`, `na-ashburn`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceEngineRegionInfoArgs']]]] engine_region_infos: Details about the regional configuration of the engine in cross-region deployment, only zookeeper professional requires
               the use of the EngineRegionInfos parameter.
        :param pulumi.Input[str] engine_resource_spec: engine spec ID. see EngineProductVersion.
        :param pulumi.Input[str] engine_type: engine type. Reference value: `zookeeper`, `nacos`, `polaris`.
        :param pulumi.Input[str] engine_version: An open source version of the engine. Each engine supports different open source versions, refer to the product
