...
class Dnat(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Dnat resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a Dnat resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DnatArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DnatArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DnatArgs.__new__(DnatArgs)
        ...
        super(Dnat, __self__).__init__(
            'tencentcloud:Dnat/dnat:Dnat',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            private_port: Optional[pulumi.Input[str]] = None,
            protocol: Optional[pulumi.Input[str]] = None,
            vpc_id: Optional[pulumi.Input[str]] = None) -> 'Dnat':
        """
        ...
        __props__ = _DnatState.__new__(_DnatState)
        ...
        __props__.__dict__["protocol"] = protocol
        __props__.__dict__["vpc_id"] = vpc_id
        return Dnat(resource_name, opts=opts, __props__=__props__)
