...
class FunctionTargetsAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] domain: The domain name of the target forwarding rule. If the LocationId parameter has been entered, this parameter will not
               take effect.
        :param pulumi.Input[str] location_id: The ID of the target forwarding rule. When binding the cloud function to a layer-7 forwarding rule, this parameter or
               the Domain+Url parameter must be entered.
        :param pulumi.Input[str] url: The URL of the target forwarding rule. If the LocationId parameter has been entered, this parameter will not take
               effect.
        """
...
class FunctionTargetsAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FunctionTargetsAttachment resource with the given unique name, props, and options.
