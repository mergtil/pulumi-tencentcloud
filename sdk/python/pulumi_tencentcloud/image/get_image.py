...
def get_image(filters: Optional[Sequence[pulumi.InputType['GetImageFilterArgs']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Image/getImage:getImage', __args__, opts=opts, typ=GetImageResult).value
...
def get_image_output(filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetImageFilterArgs']]]]] = None,
