...
class AuditLogFileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] order_by: Sort field. supported values are: `timestamp` - timestamp `affectRows` - affected rows `execTime` - execution time.
        """
...
class AuditLogFile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AuditLogFile resource with the given unique name, props, and options.
