...
class MigrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] source_type: Type of migration source 1 TencentDB for SQLServer 2 Cloud server self-built SQLServer database 4 SQLServer backup and
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MigrationRenameRestoreArgs']]] rename_restores: Restore and rename the database in ReNameRestoreDatabase. If it is not filled in, the restored database will be named by
...
class Migration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] migrate_name: Name of the migration task.
        :param pulumi.Input[int] migrate_type: Migration type (1 structure migration 2 data migration 3 incremental synchronization).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['MigrationRenameRestoreArgs']]]] rename_restores: Restore and rename the database in ReNameRestoreDatabase. If it is not filled in, the restored database will be named by
               default and all databases will be restored. Valid if SourceType=5.
