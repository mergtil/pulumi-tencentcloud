...
class FullBackupMigrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] recovery_type: Migration task restoration type. FULL: full backup restoration, FULL_LOG: full backup and transaction log restoration,
               FULL_DIFF: full backup and differential backup restoration.
        :param pulumi.Input[str] upload_type: Backup upload type. COS_URL: the backup is stored in users Cloud Object Storage, with URL provided. COS_UPLOAD: the
               backup is stored in the applications Cloud Object Storage and needs to be uploaded by the user.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] backup_files: If the UploadType is COS_URL, fill in the URL here. If the UploadType is COS_UPLOAD, fill in the name of the backup file
...
class FullBackupMigration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FullBackupMigration resource with the given unique name, props, and options.
