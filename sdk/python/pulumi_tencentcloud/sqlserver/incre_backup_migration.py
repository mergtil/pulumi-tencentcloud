...
class IncreBackupMigrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] backup_files: Incremental backup file. If the UploadType of a full backup file is COS_URL, fill in URL here. If the UploadType is
...
class IncreBackupMigration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IncreBackupMigration resource with the given unique name, props, and options.
