...
class RestoreInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['RestoreInstanceRenameRestoreArgs']]] rename_restores: Restore the databases listed in ReNameRestoreDatabase and rename them after restoration. If this parameter is left
...
class RestoreInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RestoreInstance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[int] backup_id: Backup file ID, which can be obtained through the Id field in the returned value of the DescribeBackups API.
        :param pulumi.Input[str] instance_id: Instance ID.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['RestoreInstanceRenameRestoreArgs']]]] rename_restores: Restore the databases listed in ReNameRestoreDatabase and rename them after restoration. If this parameter is left
               empty, all databases will be restored and renamed in the default format.
        """
        ...
    @overload
