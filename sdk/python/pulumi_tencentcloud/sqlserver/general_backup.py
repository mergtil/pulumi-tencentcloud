...
class GeneralBackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] backup_name: Backup name. If this parameter is left empty, a backup name in the format of [Instance ID]_[Backup start timestamp] will
...
class GeneralBackup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a GeneralBackup resource with the given unique name, props, and options.
