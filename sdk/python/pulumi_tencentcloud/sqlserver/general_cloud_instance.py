...
class GeneralCloudInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] machine_type: The host disk type of the purchased instance, CLOUD_HSSD-enhanced SSD cloud disk for virtual machines,
        ...
        :param pulumi.Input[str] zone: Instance AZ, such as ap-guangzhou-1 (Guangzhou Zone 1). Purchasable AZs for an instance can be obtained through the
               DescribeZones API.
        :param pulumi.Input[int] auto_renew_flag: Automatic renewal flag: 0-normal renewal 1-automatic renewal, the default is 1 automatic renewal. Valid only when
        ...
        :param pulumi.Input[str] db_version: sqlserver version, currently all supported versions are: 2008R2 (SQL Server 2008 R2 Enterprise), 2012SP3 (SQL Server
        ...
        :param pulumi.Input[str] ha_type: Upgrade the high-availability architecture of sqlserver, upgrade from mirror disaster recovery to always on cluster
        ...
        :param pulumi.Input[int] period: Purchase instance period, the default value is 1, which means one month. The value cannot exceed 48. Valid only when the
        ...
        :param pulumi.Input[str] subnet_id: VPC subnet ID, in the form of subnet-bdoe83fa; SubnetId and VpcId need to be set at the same time or not set at the same
               time.
        :param pulumi.Input[str] time_zone: System time zone, default: China Standard Time.
        :param pulumi.Input[str] vpc_id: VPC network ID, in the form of vpc-dsp338hz; SubnetId and VpcId need to be set at the same time or not set at the same
               time.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] weeklies: Maintainable time window configuration, in weeks, indicates the days of the week that allow maintenance, 1-7 represent
...
class GeneralCloudInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a GeneralCloudInstance resource with the given unique name, props, and options.
