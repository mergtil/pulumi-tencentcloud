...
class ConfigInstanceRoGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] auto_weight: 0-user-defined weight (adjusted according to WeightPairs), 1-system automatically assigns weight (WeightPairs is
        ...
        :param pulumi.Input[int] min_read_only_in_group: After the timeout removal function is enabled, the number of read-only copies retained by the read-only group at least,
        ...
        :param pulumi.Input[int] read_only_max_delay_time: After the timeout elimination function is enabled, the timeout threshold used, if this parameter is not filled, it will
               not be modified.
...
class ConfigInstanceRoGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ConfigInstanceRoGroup resource with the given unique name, props, and options.
