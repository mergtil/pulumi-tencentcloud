...
class BusinessIntelligenceInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] machine_type: The host type of purchased instance. Valid values: CLOUD_PREMIUM (virtual machine with premium cloud disk), CLOUD_SSD
        ...
        :param pulumi.Input[str] zone: Instance AZ, such as ap-guangzhou-1 (Guangzhou Zone 1). Purchasable AZs for an instance can be obtained through
               theDescribeZones API.
        :param pulumi.Input[str] db_version: Supported versions of business intelligence server. Valid values: 201603 (SQL Server 2016 Integration Services), 201703
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] weeklies: Configuration of the maintenance window, which specifies the day of the week when maintenance can be performed. Valid
...
class BusinessIntelligenceInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BusinessIntelligenceInstance resource with the given unique name, props, and options.
