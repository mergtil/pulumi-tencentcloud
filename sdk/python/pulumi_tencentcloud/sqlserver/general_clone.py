...
class GeneralCloneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] new_name: New database name. In offline migration, OldName will be used if NewName is left empty (OldName and NewName cannot be
               both empty). In database cloning, OldName and NewName must be both specified and cannot have the same value.
        :param pulumi.Input[str] old_name: Database name. If the OldName database does not exist, a failure will be returned. It can be left empty in offline
               migration tasks.
        """
...
class GeneralClone(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a GeneralClone resource with the given unique name, props, and options.
