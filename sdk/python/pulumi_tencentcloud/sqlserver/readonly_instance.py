...
class ReadonlyInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] readonly_groups_is_offline_delay: Required when `readonly_group_type`=2, whether the newly created read-only group has delay elimination enabled,
               1-enabled, 0-disabled. When the delay between the read-only copy and the primary instance exceeds the threshold, it is
               automatically removed.
        :param pulumi.Input[int] readonly_groups_max_delay_time: Required when `readonly_group_type`=2 and `readonly_groups_is_offline_delay`=1, the threshold for delayed elimination of
               newly created read-only groups.
        :param pulumi.Input[int] readonly_groups_min_in_group: When `readonly_group_type`=2 and `readonly_groups_is_offline_delay`=1, it is required. After the newly created read-only
