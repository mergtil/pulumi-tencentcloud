...
class InstanceTdeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] certificate_attribution: Certificate attribution. self- means to use the account's own certificate, others- means to refer to the certificate of
...
class InstanceTde(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InstanceTde resource with the given unique name, props, and options.
