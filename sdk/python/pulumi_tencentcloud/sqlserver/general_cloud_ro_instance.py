...
class GeneralCloudRoInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] read_only_group_type: Read-only group type option, 1- Ship according to one instance and one read-only group, 2 - Ship after creating a
        ...
        :param pulumi.Input[str] zone: Instance Availability Zone, similar to ap-guangzhou-1 (Guangzhou District 1); the instance sales area can be obtained
        ...
        :param pulumi.Input[int] read_only_group_is_offline_delay: Required when ReadOnlyGroupType=2, whether to enable the delayed elimination function for the newly created read-only
        ...
        :param pulumi.Input[int] read_only_group_max_delay_time: Mandatory when ReadOnlyGroupType=2 and ReadOnlyGroupIsOfflineDelay=1, the threshold for delay culling of newly created
               read-only groups.
        :param pulumi.Input[int] read_only_group_min_in_group: Required when ReadOnlyGroupType=2 and ReadOnlyGroupIsOfflineDelay=1, the newly created read-only group retains at least
...
class GeneralCloudRoInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a GeneralCloudRoInstance resource with the given unique name, props, and options.
