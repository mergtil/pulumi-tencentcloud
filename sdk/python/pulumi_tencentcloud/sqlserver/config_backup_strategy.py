...
class ConfigBackupStrategyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] backup_cycles: The days of the week on which backup will be performed when `BackupType` is weekly. If data backup retention period is
        ...
        :param pulumi.Input[str] backup_model: Backup mode. Valid values: master_pkg (archive the backup files of the primary node), master_no_pkg (do not archive the
        ...
        :param pulumi.Input[str] backup_type: Backup type. Valid values: weekly (when length(BackupDay) <=7 && length(BackupDay) >=2), daily (when
...
class ConfigBackupStrategy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ConfigBackupStrategy resource with the given unique name, props, and options.
