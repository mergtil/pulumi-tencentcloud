...
def get_instance(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Deprecatedvpc/getInstance:getInstance', __args__, opts=opts, typ=GetInstanceResult).value
...
def get_instance_output(id: Optional[pulumi.Input[Optional[str]]] = None,
