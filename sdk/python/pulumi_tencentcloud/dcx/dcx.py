...
class Dcx(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Dcx resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a Dcx resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DcxArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DcxArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DcxArgs.__new__(DcxArgs)
        ...
        super(Dcx, __self__).__init__(
            'tencentcloud:Dcx/dcx:Dcx',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tencent_address: Optional[pulumi.Input[str]] = None,
            vlan: Optional[pulumi.Input[int]] = None,
            vpc_id: Optional[pulumi.Input[str]] = None) -> 'Dcx':
        """
        ...
        __props__ = _DcxState.__new__(_DcxState)
        ...
        __props__.__dict__["vlan"] = vlan
        __props__.__dict__["vpc_id"] = vpc_id
        return Dcx(resource_name, opts=opts, __props__=__props__)
