...
class ExtraConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] jumbo_enable: direct connect tunnel support jumbo frame1: enable direct connect tunnel jumbo frame0: disable direct connect tunnel
               jumbo frame.
...
class ExtraConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ExtraConfig resource with the given unique name, props, and options.
