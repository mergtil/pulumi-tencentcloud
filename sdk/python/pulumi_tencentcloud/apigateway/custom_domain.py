...
class CustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] is_forced_https: Whether to force HTTP requests to jump to HTTPS, default to false. When the parameter is true, the API gateway will
