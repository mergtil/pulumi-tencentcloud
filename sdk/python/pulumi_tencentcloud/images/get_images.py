...
def get_images(image_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Images/getImages:getImages', __args__, opts=opts, typ=GetImagesResult).value
...
def get_images_output(image_id: Optional[pulumi.Input[Optional[str]]] = None,
