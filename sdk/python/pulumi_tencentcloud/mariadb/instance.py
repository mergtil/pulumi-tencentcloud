...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] storage: Storage size, unit: GB. You can query instance specifications through DescribeDBInstanceSpecs to obtain the lower and
               upper limits of disk specifications corresponding to different memory sizes.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] zones: Instance node availability zone distribution, up to two availability zones can be filled. When the shard specification
        ...
        :param pulumi.Input[Sequence[pulumi.Input['InstanceInitParamArgs']]] init_params: Parameter list. The optional values of this interface are: character_set_server (character set, required) enum:
...
class _InstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] instance_name: Instance name, you can set the name of the instance independently through this field.
        :param pulumi.Input[int] instance_type: 1: primary instance (exclusive), 2: primary instance, 3: disaster recovery instance, 4: disaster recovery instance
               (exclusive type).
        :param pulumi.Input[int] ipv6_flag: Whether IPv6 is supported.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_group_ids: Security group ID list.
        :param pulumi.Input[int] status: Instance status: 0 creating, 1 process processing, 2 running, 3 instance not initialized, -1 instance isolated, 4
...
class Instance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] dcn_instance_id: DCN source instance ID.
        :param pulumi.Input[str] dcn_region: DCN source region.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['InstanceInitParamArgs']]]] init_params: Parameter list. The optional values of this interface are: character_set_server (character set, required) enum:
               utf8,latin1,gbk,utf8mb4,gb18030, lower_case_table_names (table name case sensitive, required, 0 - sensitive; 1 -
               insensitive), innodb_page_size (innodb data page, Default 16K), sync_mode (sync mode: 0 - asynchronous; 1 - strong
               synchronous; 2 - strong synchronous can degenerate. The default is strong synchronous can degenerate).
        :param pulumi.Input[str] instance_name: Instance name, you can set the name of the instance independently through this field.
