...
class DatahubTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Name, start with appid, which is a string of no more than 128 characters, must start with a letter, and the rest can
               contain letters, numbers, and dashes (-).
        :param pulumi.Input[str] note: Subject note, which is a string of no more than 64 characters, must start with a letter, and the rest can contain
...
class DatahubTopic(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DatahubTopic resource with the given unique name, props, and options.
