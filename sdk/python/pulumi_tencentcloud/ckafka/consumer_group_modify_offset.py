...
class ConsumerGroupModifyOffsetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] strategy: Reset the policy of offset. `0`: Move the offset forward or backward shift bar; `1`: Alignment reference
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] partitions: The list of partition that needs to be reset if no Topics parameter is specified. Resets the partition in the
        ...
        :param pulumi.Input[int] shift: This field must be included when strategy is 0. If it is greater than zero, the offset will be moved backward by shift
        ...
        :param pulumi.Input[int] shift_timestamp: Unit ms. When strategy is 1, you must include this field, where-2 means to reset the offset to the beginning,-1 means to
...
class ConsumerGroupModifyOffset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ConsumerGroupModifyOffset resource with the given unique name, props, and options.
