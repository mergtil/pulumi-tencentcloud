...
class AuthenticateDomainOwnerOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] verify_type: Authentication type. Possible values:`dnsCheck`: Immediately verify whether the resolution record of the configured dns
...
class AuthenticateDomainOwnerOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a AuthenticateDomainOwnerOperation resource with the given unique name, props, and options.
