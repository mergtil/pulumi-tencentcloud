...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] is_mini_program_live: `0`: LVB. `1`: LVB on Mini Program. Note: this field may return null, indicating that no valid values can be obtained.
               Default value is 0.
        :param pulumi.Input[int] play_type: Play Type. This parameter is valid only if `DomainType` is 1. Available values: `1`: in Mainland China. `2`: global.
