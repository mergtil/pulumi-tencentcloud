...
class PlayDomainCertAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['PlayDomainCertAttachmentDomainInfoArgs'] domain_info: The playback domains to bind and whether to enable HTTPS for them. If `CloudCertId` is unspecified, and a domain is
               already bound with a certificate, this API will only update the HTTPS configuration of the domain.
        :param pulumi.Input[str] cloud_cert_id: Tencent cloud ssl certificate Id. Refer to `tencentcloud_ssl_certificate` to create or obtain the resource ID.
        """
...
class PlayDomainCertAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PlayDomainCertAttachment resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] cloud_cert_id: Tencent cloud ssl certificate Id. Refer to `tencentcloud_ssl_certificate` to create or obtain the resource ID.
        :param pulumi.Input[pulumi.InputType['PlayDomainCertAttachmentDomainInfoArgs']] domain_info: The playback domains to bind and whether to enable HTTPS for them. If `CloudCertId` is unspecified, and a domain is
               already bound with a certificate, this API will only update the HTTPS configuration of the domain.
        """
        ...
    @overload
