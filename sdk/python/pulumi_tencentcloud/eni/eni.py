...
class EniArgs:
    def __init__(__self__, *,
                 ...
                 ipv4s: Optional[pulumi.Input[Sequence[pulumi.Input['EniIpv4Args']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EniIpv4Args']]] ipv4s: Applying for intranet IPv4s collection, conflict with `ipv4_count`. When there are multiple ipv4s, can only be one
    ...
    @property
    @pulumi.getter
    def ipv4s(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['EniIpv4Args']]]]:
        """
    ...
    @ipv4s.setter
    def ipv4s(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['EniIpv4Args']]]]):
...
class _EniState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 ipv4_count: Optional[pulumi.Input[int]] = None,
                 ipv4_infos: Optional[pulumi.Input[Sequence[pulumi.Input['EniIpv4InfoArgs']]]] = None,
                 ipv4s: Optional[pulumi.Input[Sequence[pulumi.Input['EniIpv4Args']]]] = None,
        ...
        :param pulumi.Input[int] ipv4_count: The number of intranet IPv4s. When it is greater than 1, there is only one primary intranet IP. The others are auxiliary
               intranet IPs, which conflict with `ipv4s`.
        :param pulumi.Input[Sequence[pulumi.Input['EniIpv4InfoArgs']]] ipv4_infos: An information list of IPv4s. Each element contains the following attributes:
        :param pulumi.Input[Sequence[pulumi.Input['EniIpv4Args']]] ipv4s: Applying for intranet IPv4s collection, conflict with `ipv4_count`. When there are multiple ipv4s, can only be one
               primary IP, and the maximum length of the array is 30. Each element contains the following attributes:
    ...
    def ipv4_infos(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['EniIpv4InfoArgs']]]]:
        """
    ...
    @ipv4_infos.setter
    def ipv4_infos(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['EniIpv4InfoArgs']]]]):
...
class Eni(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 ipv4_count: Optional[pulumi.Input[int]] = None,
                 ipv4s: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EniIpv4Args']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 subnet_id: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 ...
                 __props__=None):
        """
        Create a Eni resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] description: Description of the ENI, maximum length 60.
        :param pulumi.Input[int] ipv4_count: The number of intranet IPv4s. When it is greater than 1, there is only one primary intranet IP. The others are auxiliary
               intranet IPs, which conflict with `ipv4s`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EniIpv4Args']]]] ipv4s: Applying for intranet IPv4s collection, conflict with `ipv4_count`. When there are multiple ipv4s, can only be one
               primary IP, and the maximum length of the array is 30. Each element contains the following attributes:
        :param pulumi.Input[str] name: Name of the ENI, maximum length 60.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_groups: A set of security group IDs.
        :param pulumi.Input[str] subnet_id: ID of the subnet within this vpc.
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[str]] = None,
            ipv4_count: Optional[pulumi.Input[int]] = None,
            ipv4_infos: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EniIpv4InfoArgs']]]]] = None,
            ipv4s: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EniIpv4Args']]]]] = None,
            mac: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            primary: Optional[pulumi.Input[bool]] = None,
            ...
            subnet_id: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            vpc_id: Optional[pulumi.Input[str]] = None) -> 'Eni':
        """
        ...
        :param pulumi.Input[int] ipv4_count: The number of intranet IPv4s. When it is greater than 1, there is only one primary intranet IP. The others are auxiliary
               intranet IPs, which conflict with `ipv4s`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EniIpv4InfoArgs']]]] ipv4_infos: An information list of IPv4s. Each element contains the following attributes:
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EniIpv4Args']]]] ipv4s: Applying for intranet IPv4s collection, conflict with `ipv4_count`. When there are multiple ipv4s, can only be one
               primary IP, and the maximum length of the array is 30. Each element contains the following attributes:
        :param pulumi.Input[str] mac: MAC address.
        :param pulumi.Input[str] name: Name of the ENI, maximum length 60.
    ...
    @property
    @pulumi.getter(name="ipv4Infos")
    def ipv4_infos(self) -> pulumi.Output[Sequence['outputs.EniIpv4Info']]:
        """
        An information list of IPv4s. Each element contains the following attributes:
        """
        return pulumi.get(self, "ipv4_infos")
    ...
    @property
    @pulumi.getter
    def ipv4s(self) -> pulumi.Output[Optional[Sequence['outputs.EniIpv4']]]:
        """
        Applying for intranet IPv4s collection, conflict with `ipv4_count`. When there are multiple ipv4s, can only be one
        primary IP, and the maximum length of the array is 30. Each element contains the following attributes:
        """
