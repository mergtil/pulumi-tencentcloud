...
class ModifyDiagDbInstanceOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] product: Service product type, supported values include: mysql - cloud database MySQL, cynosdb - cloud database CynosDB for
               MySQL.
...
class ModifyDiagDbInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ModifyDiagDbInstanceOperation resource with the given unique name, props, and options.
