...
class TdsqlAuditLogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] product: Service product type, supported values include: dcdb - cloud database Tdsql, mariadb - cloud database MariaDB for
               MariaDB..
...
class TdsqlAuditLog(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TdsqlAuditLog resource with the given unique name, props, and options.
