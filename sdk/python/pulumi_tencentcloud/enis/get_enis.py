...
class GetEnisResult:
    ...
    @property
    @pulumi.getter
    def enis(self) -> Sequence['outputs.GetEnisEniResult']:
...
def get_enis(description: Optional[str] = None,
             ...
             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnisResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Enis/getEnis:getEnis', __args__, opts=opts, typ=GetEnisResult).value
...
@_utilities.lift_output_func(get_enis)
def get_enis_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetEnisResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
