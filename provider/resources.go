...
import (
	...
	"github.com/mergtil/pulumi-tencentcloud/provider/info"
	"github.com/mergtil/pulumi-tencentcloud/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		License:    "Apache-2.0",
		Homepage:   "https://github.com/pulumi/pulumi-tencentcloud",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/mergtil/pulumi-%[1]s/sdk/", mainPkg),
